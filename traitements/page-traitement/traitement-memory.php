    ...
    if(isset($_GET['lien'])) {
        ...
        if(isset($_SESSION['tableau'])) {
            ...
            if($_SESSION['tableau'][1]->valeur == $_SESSION['tableau'][2]->valeur) {
                ...
                // if(la_fonction_qui_compte() === 0) {

                //     unset($_SESSION['compteur']);
                //     $endgame = 'Tu as terminée le jeux !';

                // }
                // if($_SESSION['game'][$_GET['lien']]->valeur == 'open') {
                ...
                if($_SESSION['nbPaire'] == $_SESSION['nb_carte']) {
                    ...
                    $score->registerCoup($_SESSION['level'], $_SESSION['coup'], $_SESSION['point'], $_SESSION['id']); 
...
// if ($_SESSION["prevlien"] != $_GET['lien'] && isset($_GET['lien']))
//     $_SESSION['compteur']++;
